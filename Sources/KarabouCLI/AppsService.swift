...
class AppsService {
    private static var hardcodedApps: [App] = [
        ...
        App(name: "Messages", bundleIdentifier: "com.apple.MobileSMS", appPath: "/Applications/Messages.app"),
    ]
    ...
    private static func getInstalledApps() -> [App] {
        ...
        // Scan /Applications/Chrome Apps.localized/ folder
        let chromeAppsPath = "/Applications/Chrome Apps.localized"
        if let chromeApps = scanDirectoryForApps(at: chromeAppsPath) {
            installedApps.append(contentsOf: chromeApps)
        }
    ...
    private static func isBackgroundApp(name: String, bundleIdentifier: String) -> Bool {
        ...
        if lowercasedName.contains("helper") ||
           lowercasedName.contains("background") ||
           lowercasedName.contains("agent") ||
           lowercasedName.contains("daemon") ||
           lowercasedName.contains("service") ||
           lowercasedName.contains("plugin") ||
